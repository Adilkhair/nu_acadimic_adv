   ...
   <div class="row">
     <div class="col-sm-12 col-md-3">
       ...
       <!--<img src="assets/img/logo.png" class="card-img-top" alt="...">-->
        ...
        <div class="card-body">
         <p  style="" class="card-text"><i class="bx bx-id-card" style="font-size: 25px"> </i> <?php echo $user->name; ?></p>
         <!-- <p class="card-text"><i class="bx bx-phone"  style="font-size: 25px"> </i> <?php echo $user->name; ?></p>
       -->   <p class="card-text"><i class="bx bx-mail-send" style="font-size: 25px"> </i> <?php echo $user->email; ?> </p>
       ...
       <div class="row" style="background-color: #EFEFEF; margin-bottom: 10px; margin-top: 10px">
         <div class="col-9">
          ...
          <!--   <b><a href="students" style="float: left; padding-right: 10px"> <i class="bx bx-arrow-back" style="font-size:30px"></i></a></b>
             -->
             <b><a href=" {{ url('showtForms') }}" style="float: left; padding-right: 10px"> <i class=" bx bx-chevron-left"  style="font-size:30px"></i></a></b>
               <b><a href=" {{ url('home') }}" style="float: left; padding-right: 10px"><i class="bx bx-home-alt"  style="font-size:30px"></i></a></b>
              <b><a href="{{ url('getFormsTemplate/'.$user->id) }}" style="float: left; padding-left: 10px">  + <i class="bx bx-file" style="font-size:30px"></i> </a></b>
...
<a href="{{url('answers/'.$data->student_id.'/'.$data->id.'/'.$data->form_name)}}">
